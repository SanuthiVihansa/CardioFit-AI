...
class RecognitionScreenScan extends StatefulWidget {
  const RecognitionScreenScan({super.key});

  @override
  State<RecognitionScreenScan> createState() => _RecognitionScreenScan();
}
...
class _RecognitionScreenScan extends State<RecognitionScreenScan> {
      ...
      if (item["UploadedImage"] != null) {
        ...
        if (image != null) {
          ...
          FormData formData = FormData.fromMap(
            {
              'image': await MultipartFile.fromFile(image.path, filename: 'image.txt'),
            },
          );
          Response response;

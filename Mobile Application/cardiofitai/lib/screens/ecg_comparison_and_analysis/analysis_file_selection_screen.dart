...
class AnalysisFileSelectionScreen extends StatefulWidget {
  const AnalysisFileSelectionScreen({super.key});

  @override
  State<AnalysisFileSelectionScreen> createState() =>
      _AnalysisFileSelectionScreenState();
}

class _AnalysisFileSelectionScreenState
    extends State<AnalysisFileSelectionScreen> {
  late double _width;
  late double _height;
    ...
    Navigator.push(
        ...
        MaterialPageRoute(
            builder: (BuildContext context) =>
                AnalysisAllLeadPredictionWithRadioBtnsScreen(_l1Data, _l2Data,

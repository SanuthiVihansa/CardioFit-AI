...
import 'dart:convert';
import 'dart:io';
import 'package:cardiofitai/screens/ecg_comparison_and_analysis/analysis_all_lead_prediction_with_radio_btns_screen.dart';
import 'package:cardiofitai/screens/ecg_comparison_and_analysis/comparison_all_lead_prediction_with_radio_btns_screen.dart';
...
class ComparisonFileSelectionScreen extends StatefulWidget {
  const ComparisonFileSelectionScreen({super.key});

  @override
  State<ComparisonFileSelectionScreen> createState() =>
      _ComparisonFileSelectionScreenState();
}

class _ComparisonFileSelectionScreenState
    extends State<ComparisonFileSelectionScreen> {
  late double _width;
  late double _height;
    ...
    Navigator.push(
        ...
        MaterialPageRoute(
            builder: (BuildContext context) =>
                ComparisonAllLeadPredictionWithRadioBtnsScreen(_l1Data, _l2Data,

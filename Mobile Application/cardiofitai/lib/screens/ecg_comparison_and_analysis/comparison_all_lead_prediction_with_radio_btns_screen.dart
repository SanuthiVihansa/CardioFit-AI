...
import '../facial_analysis/facial_analysis_home.dart';

class ComparisonAllLeadPredictionWithRadioBtnsScreen extends StatefulWidget {
  const ComparisonAllLeadPredictionWithRadioBtnsScreen(
      this.l1Data,
      this.l2Data,
      this.v1Data,
      this.v2Data,
  ...
  @override
  State<ComparisonAllLeadPredictionWithRadioBtnsScreen> createState() =>
      _ComparisonAllLeadPredictionWithRadioBtnsScreenState();
}

class _ComparisonAllLeadPredictionWithRadioBtnsScreenState
    extends State<ComparisonAllLeadPredictionWithRadioBtnsScreen> {
  late double _width;
  late double _height;
              ...
              Expanded(
                child: Row(
                  ...
                  children: [
                    Text(
                      "Selected Lead: ",
                      style: TextStyle(fontSize: _width / (_devWidth / 12)),
                    ),

          ...
          children: <Widget>[
                ...
                child: LineChart(
                  LineChartData(
                    lineBarsData: [
                      ...
                      LineChartBarData(
                        spots: _prIntervals
                            .map((interval) => FlSpot(interval['qrs'].toDouble(), _ecgData[interval['qrs']]))
                            .toList(),
                        isCurved: false,
                      ...
                      LineChartBarData(
                        spots: _stSegments
                            .map((segment) => FlSpot(segment['tWaveStart'].toDouble(), _ecgData[segment['tWaveStart']]))
                            .toList(),
                        isCurved: false,
                        colors: [Colors.green],
                        barWidth: 2,
                      ...
                      LineChartBarData(
                        spots: _qtIntervals
                            .map((interval) => FlSpot(interval['tWaveEnd'].toDouble(), _ecgData[interval['tWaveEnd']]))
                            .toList(),
                        isCurved: false,
            ...
            Padding(
              ...
              child: Row(
                mainAxisAlignment: MainAxisAlignment.center,
                children: [
                  _buildLegendItem(Colors.red, 'P Waves'),
                  SizedBox(width: 10),
                  _buildLegendItem(Colors.orange, 'PR Intervals'),
                  SizedBox(width: 10),
                  _buildLegendItem(Colors.green, 'ST Segments'),
                  SizedBox(width: 10),
                  _buildLegendItem(Colors.purple, 'QT Intervals'),
                ],
              ),
            ),
          ],

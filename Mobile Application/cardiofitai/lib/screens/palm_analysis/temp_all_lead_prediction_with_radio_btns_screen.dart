...
class TempAllLeadPredictionWithRadioBtnsScreen extends StatefulWidget {
  ...
  @override
  State<TempAllLeadPredictionWithRadioBtnsScreen> createState() =>
      _TempAllLeadPredictionWithRadioBtnsScreenState();
}

class _TempAllLeadPredictionWithRadioBtnsScreenState
    extends State<TempAllLeadPredictionWithRadioBtnsScreen> {
  late double _width;
  late double _height;
